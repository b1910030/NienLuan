        ...
        <div class="row" style="margin-top: 120px">
          <div class="col-12 col-md-12 col-lg-7 mb-5">
            <div class="card border-0 p-2">
              <h3 class="fw-bolder title mb-4">About Tour</h3>
              {!! $tour->description !!}
            </div>
          </div>
            ...
            <div class="card bordered card-form" style="padding: 30px 40px">
              ...
              >
                ...
                <span class="text-gray-500 font-weight-light"
                  >{{ number_format($tour->price) }} VND</span
                >
              </div>
              <div
                class="alert alert-secondary"
             ...
             <div class="card-bank d-flex align-items-center justify-content-around">
              ...
              <a href="{{ route('checkout', $tour->id) }}"  class="btn btn-book btn-block mt-3"
                >Continue to Book</a
              >
            </div>
          </div>
          ...
          <form class="form" method="POST" action="{{route('user.review_tour', $tour)}}">
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <div class="col-lg-12 col-12">
                      <div class="form-group">
                        <textarea name="review" cols="80" rows="6" placeholder="Write a review..." ></textarea>
                      </div>
                    </div>
                    <div class="col-lg-12 col-12">
           ...
           <div class="ratting-main">
            <div class="avg-ratting">
              ...
              <span style="font-size: 30px"><strong>All Review</strong></span> 
            </div> <hr> <br>
