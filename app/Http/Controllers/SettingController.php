    ...
    public function update_password(Request $request){
        ...
        if(Hash::check($request['current_password'], $user->password)){
            if($request['new_password'] == $request['confirm_password']){
                ...
                return redirect()->route('settings.index')->with('message', 'Change Password Successfully !');
            } else {
                return redirect()->route('settings.index')->with('error', 'Confirm password is incorrect !');
            }
            
        } else {
            return redirect()->route('settings.index')->with('error', 'Passord is incorrect !');
        }     
    }
